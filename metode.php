                ...
                <div class="card-body">
                  ...
                  <div class="col-6 mb-4">
                    <div class="metode-bayar">
                      <img src="<?php echo $hasils['data'][$i]['icon_url']; ?>" class="img-fluid text-center" style="margin-bottom: -10px; display: block; width: auto; height: 35px;">
                      <hr>
                      <p style="font-weight: normal; color: #000;"><?php echo $hasils['data'][$i]['name']; ?></p>
                    </div>
                  </div>
                  <?php
                      }
